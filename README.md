Need to correct deploy settings - for now commit to readme to push vercel updates                      
  
This a complete example of fullstack NFT minting dApp. is built with the purpose of providing an _entry point for future NFT Minting Website_ projects.
